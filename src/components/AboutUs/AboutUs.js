    ...
    <div className="about-us">
      ...
      <div className="about-us-main">
        ...
        <p className="about-us-content">
          ...
          students to face industrial challenges. We also help students discover
          their potential, implement their ideas, innovate and grow and learn
          everyday to gain the skills which are going to help them a lifetime.
        </p>
      </div>
    </div>
  );
