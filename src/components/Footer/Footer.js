    ...
    <div className="footer-distributed">
      <div className="footer-left">
        <div className="col">
          ...
          <div className="copy">
            ...
            >
              Copyright © 2024 E-cell MediCaps
            </p>
      ...
      <div className="footer-right">
        ...
        <div className="footer-icons">
          <a href="https://goo.gl/maps/febYS8gU1YjHS7hb8">
            <FaMapMarkedAlt />
          </a>
          <a href="https://www.instagram.com/medicaps_ecell/">
            <FaInstagram />
          </a>
          <a href="www.linkedin.com/in/e-cell-medi-caps-university">
            <FaLinkedin />
          </a>
